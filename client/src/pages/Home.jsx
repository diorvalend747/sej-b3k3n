...
import { useFetchCategory, useFetchBook } from "../hooks";
...
export default function Home() {
  ...
  const [isLoadingBook, setCategoryId, setPage, page, pageSize, setPageSize] =
    useFetchBook();
                  ...
                  .filter((item) => {
                    if (!searchInput) {
                      ...
                      return (
                        ...
                        item.authors[0].toLowerCase().includes(searchInput)
                      );
                    }
                  })
                  .map((book) => {
            ...
            {isLoadingBook ? (
              ...
              <div className="flex justify-center pt-9">
                <button
                  ...
                  className="inline-flex items-center py-2 px-4 mr-4 text-sm font-medium rounded-lg bg-white hover:bg-gray-400 text-black"
                >
                  <svg
                    class="mr-2 w-5 h-5"
                    fill="currentColor"
                ...
                <button
                  ...
                  className="inline-flex items-center py-2 px-4 ml-4 text-sm font-medium text-black rounded-lg bg-white hover:bg-gray-400"
                >
                  Next
                  <svg
                    class="ml-2 w-5 h-5"
          ...
          <>
            ...
            {isLoadingCategory ? (
              ...
              <>
                <div
                  id="categories"
                  className="flex items-center overflow-x-auto pb-4 gap-3 lg:pb-0"
                >
                ...
                <h1 className="font-bold text-xl mt-14 mb-8 text-white">
                  Popular This Week
                </h1>
                <div className="grid gap-5 md:gap-8 grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 transition-all">
                  {isLoadingBook ? (
